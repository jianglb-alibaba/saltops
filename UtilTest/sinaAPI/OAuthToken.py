...
#     def  __init__(self,
#
#  oauth_token, oauth_token_secret, oauth_verifier = None,  ** kw):  
...
#     def  __init__(self,
#
#  app_key, app_secret, token = None, callback = None, domain = 'api.t.sina.com.cn'):  
...
# def  _http_call(url,
#
#  method, authorization = None, return_json = True,  ** kw):  
#     ''''' 
...
#
# :  
#             return self.client._oauth_request(self.method, '%s/%s.json'  %  (self.client.api_url, attr.replace(
#     '__', '/')),   ** kw)  
#         return wrap  
#   
# ################################################################################  
...
#   
# def  _generate_base_string(method,
#
#  url,  ** params):  
#     ''''' 
